...
(function() {
	...
	jQuery(document).ready(function (){
		...
		document.getElementById("emailForm").addEventListener("submit", function(event) {
		  ...
		  var emailLink = "mailto:contact@afmart.com?subject=" + encodeURIComponent(emailSubject) + "&body=" + encodeURIComponent(emailContent);
	
		  window.location.href = emailLink; // Ouvre l'email avec les détails préremplis
		});